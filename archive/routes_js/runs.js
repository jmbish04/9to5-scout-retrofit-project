...
export async function handleRunsGet(request, env) {
    try {
...
export async function handleDiscoveryRunPost(request, env) {
    try {
        ...
        env.DISCOVERY_WORKFLOW.create({ config_id: configId });
