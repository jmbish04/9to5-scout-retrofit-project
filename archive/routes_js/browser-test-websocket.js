...
export class BrowserTestWebSocket {
    ...
    async executeTestWithUpdates(config) {
        ...
        try {
            ...
            const renderingResults = await this.executeRenderingOperationsWithUpdates(config, result);
            ...
            const d1Results = await this.updateD1Database(testId, config, r2Results.keys);
    ...
    async executeRenderingOperationsWithUpdates(config, result) {
        const operations = [
    ...
    async updateStepWithWebSocket(result, stepNumber, status, details) {
    ...
    async captureScreenshot(config) {
        ...
        const response = await fetch(`https://api.cloudflare.com/client/v4/accounts/${this.env.CLOUDFLARE_ACCOUNT_ID}/browser-rendering/screenshot`, {
            method: "POST",
            headers: {
    ...
    async extractContent(config) {
        ...
        const response = await fetch(`https://api.cloudflare.com/client/v4/accounts/${this.env.CLOUDFLARE_ACCOUNT_ID}/browser-rendering/content`, {
            method: "POST",
            headers: {
                Authorization: `Bearer ${this.env.BROWSER_RENDERING_TOKEN}`,
                "Content-Type": "application/json",
    ...
    async extractJson(config) {
        ...
        const response = await fetch(`https://api.cloudflare.com/client/v4/accounts/${this.env.CLOUDFLARE_ACCOUNT_ID}/browser-rendering/json`, {
            method: "POST",
            headers: {
                Authorization: `Bearer ${this.env.BROWSER_RENDERING_TOKEN}`,
                "Content-Type": "application/json",
    ...
    async extractLinks(config) {
        ...
        const response = await fetch(`https://api.cloudflare.com/client/v4/accounts/${this.env.CLOUDFLARE_ACCOUNT_ID}/browser-rendering/links`, {
            method: "POST",
            headers: {
                Authorization: `Bearer ${this.env.BROWSER_RENDERING_TOKEN}`,
                "Content-Type": "application/json",
    ...
    async scrapeElements(config) {
        ...
        const response = await fetch(`https://api.cloudflare.com/client/v4/accounts/${this.env.CLOUDFLARE_ACCOUNT_ID}/browser-rendering/scrape`, {
            method: "POST",
            headers: {
                Authorization: `Bearer ${this.env.BROWSER_RENDERING_TOKEN}`,
                "Content-Type": "application/json",
    ...
    async generatePdf(config) {
        ...
        const response = await fetch(`https://api.cloudflare.com/client/v4/accounts/${this.env.CLOUDFLARE_ACCOUNT_ID}/browser-rendering/pdf`, {
            method: "POST",
            headers: {
                Authorization: `Bearer ${this.env.BROWSER_RENDERING_TOKEN}`,
                "Content-Type": "application/json",
    ...
    async uploadAssetsToR2(renderingResults, testId) {
        ...
        for (const [operation, result] of Object.entries(renderingResults)) {
            if (result && result.success && result.result) {
                const filename = `test_results/${testId}/${operation}-${Date.now()}.${operation === "screenshot"
                    ? "png"
                    : operation === "pdf"
                        ? "pdf"
                        : "json"}`;
    ...
    async updateD1Database(testId, config, r2Keys) {
    ...
    async testBrowserRenderingConnection() {
        try {
            const response = await fetch(`https://api.cloudflare.com/client/v4/accounts/${this.env.CLOUDFLARE_ACCOUNT_ID}/browser-rendering/screenshot`, {
                method: "POST",
                headers: {
...
export async function handleBrowserTestWebSocket(request, env) {
