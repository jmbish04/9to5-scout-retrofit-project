...
export class OpenAPIGenerator {
    ...
    version;
    description;
    constructor(baseUrl = "https://9to5-scout.workers.dev", title = "9to5 Scout API", version = "1.0.0", description = "Job scraping and monitoring API built on Cloudflare Workers") {
            ...
            components: {
                securitySchemes: {
                    bearerAuth: {
                        ...
                        scheme: "bearer",
                        bearerFormat: "JWT",
                        description: "API key for authentication. Include as: Bearer <WORKER_API_KEY>",
                    },
                },
 ...
 */
export function getPredefinedRoutes() {
    return [
        // Health check
        {
            path: "/api/health",
