/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: df379ac4f3fb0a3a198175260af59124)
// Runtime types generated with workerd@1.20250829.0 2024-09-26 nodejs_compat
declare namespace Cloudflare {
	interface Env {
		...
		JOB_MONITOR: DurableObjectNamespace /* JobMonitor */;
		SCRAPE_SOCKET: DurableObjectNamespace /* ScrapeSocket */;
		HEALTH_CHECK_SOCKET: DurableObjectNamespace /* src.core.durable-objects.health-check-socket.HealthCheckSocket */;
		GENERIC_AGENT: DurableObjectNamespace /* GenericAgent */;
		EMAIL_PROCESSOR_AGENT: DurableObjectNamespace /* EmailProcessorAgent */;
		JOB_MONITOR_AGENT: DurableObjectNamespace /* JobMonitorAgent */;
		RESUME_OPTIMIZATION_AGENT: DurableObjectNamespace /* ResumeOptimizationAgent */;
		COMPANY_INTELLIGENCE_AGENT: DurableObjectNamespace /* CompanyIntelligenceAgent */;
		INTERVIEW_PREPARATION_AGENT: DurableObjectNamespace /* InterviewPreparationAgent */;
		CAREER_COACH_AGENT: DurableObjectNamespace /* CareerCoachAgent */;
		R2: R2Bucket;
		DB: D1Database;
