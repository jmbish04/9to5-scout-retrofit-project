/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 5418dedd1c6db94d6799e5875058f14c)
// Runtime types generated with workerd@1.20251105.0 2024-09-26 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "SiteCrawler" | "JobMonitor" | "ScrapeSocket" | "GenericAgent" | "EmailProcessorAgent" | "JobMonitorAgent" | "ResumeOptimizationAgent" | "CompanyIntelligenceAgent" | "InterviewPreparationAgent" | "CareerCoachAgent";
	}
	interface Env {
		KV: KVNamespace;
		...
		SITE_CRAWLER: DurableObjectNamespace /* src.domains.scraping.durable-objects.site-crawler.do.SiteCrawler */;
		JOB_MONITOR: DurableObjectNamespace /* src.domains.jobs.durable-objects.job-monitor.do.JobMonitor */;
		SCRAPE_SOCKET: DurableObjectNamespace /* src.domains.scraping.durable-objects.scrape-socket.do.ScrapeSocket */;
		HEALTH_CHECK_SOCKET: DurableObjectNamespace /* src.core.durable-objects.health-check-socket.HealthCheckSocket */;
		GENERIC_AGENT: DurableObjectNamespace /* src.domains.agents.durable-objects.generic_agent.GenericAgent */;
		EMAIL_PROCESSOR_AGENT: DurableObjectNamespace /* src.domains.agents.durable-objects.email-processor-agent.EmailProcessorAgent */;
		JOB_MONITOR_AGENT: DurableObjectNamespace /* src.domains.agents.durable-objects.job-monitor-agent.JobMonitorAgent */;
		RESUME_OPTIMIZATION_AGENT: DurableObjectNamespace /* src.domains.agents.durable-objects.resume-optimization-agent.ResumeOptimizationAgent */;
		COMPANY_INTELLIGENCE_AGENT: DurableObjectNamespace /* src.domains.agents.durable-objects.company-intelligence-agent.CompanyIntelligenceAgent */;
		INTERVIEW_PREPARATION_AGENT: DurableObjectNamespace /* src.domains.agents.durable-objects.interview-preparation-agent.InterviewPreparationAgent */;
		CAREER_COACH_AGENT: DurableObjectNamespace /* src.domains.agents.durable-objects.career-coach-agent.CareerCoachAgent */;
		R2: R2Bucket;
		DB: D1Database;
		TASK_QUEUE: Queue;
		...
		AI: Ai;
		ASSETS: Fetcher;
		DISCOVERY_WORKFLOW: Workflow /* DiscoveryWorkflow */;
		JOB_MONITOR_WORKFLOW: Workflow /* JobMonitorWorkflow */;
		CHANGE_ANALYSIS_WORKFLOW: Workflow /* ChangeAnalysisWorkflow */;
	}
}
