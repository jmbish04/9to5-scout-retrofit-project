-- Migration: Health Tests & Results Schema
-- Purpose: D1-backed test definitions and test results for health monitoring
...
CREATE INDEX IF NOT EXISTS idx_test_defs_active ON test_defs(is_active);
