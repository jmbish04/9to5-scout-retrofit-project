...
# Script to run Talent API tests with proper virtual environment setup
# Usage: ./run_talent_tests.sh [additional python script arguments]

set -e  # Exit on any error

echo "🐍 Setting up Python test environment for Talent API..."
...
echo "🚀 Running Talent API tests..."
python3 google_talent_api.py "$@"
