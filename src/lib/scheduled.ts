...
import { handleCompanyBenefitsCron, handleStatsRollupCron } from '../routes/company-benefits';
...
export async function handleScheduledEvent(env: Env, event?: ScheduledEvent): Promise<void> {
