/**
 * @fileoverview Browser Rendering Service
 *
 * Provides a comprehensive interface for web scraping using Cloudflare's Browser Rendering REST API.
 * This service handles all browser automation tasks including screenshots, content extraction,
...
export class BrowserRenderingService {
   ...
   * @param options Browser rendering options including screenshot configuration
   * @returns Promise resolving to screenshot ArrayBuffer
   */
   ...
   * @param options Browser rendering options
   ...
   * @param options Browser rendering options
   * @returns Promise resolving to PDF ArrayBuffer
   */
   ...
   * @param options Browser rendering options with elements to scrape
   ...
   * @param options Browser rendering options with AI prompt and schema
   ...
   * @param options Scraping options including content types and configurations
   * @returns Promise resolving to comprehensive scraping result
   */
  async scrapeWebpage(
    url: string,
    options: {
   ...
   * @param result Browser rendering result to store
   * @param jobId Optional job ID to associate with the result
   * @param siteId Optional site ID to associate with the result
   ...
   * @param result Browser rendering result
   * @returns Promise resolving to content hash string
   */
...
/**
 * Factory function to create BrowserRenderingService
 * @param env Browser rendering environment configuration
 * @returns New BrowserRenderingService instance
 */
export function createBrowserRenderingService(
  env: BrowserRenderingEnv
): BrowserRenderingService {
  return new BrowserRenderingService(env);
}
